    ...
    >
      ...
      <div class="card-column left">
        ...
        >
          ...
          <img src="../assets/images/status_in.png" v-if="showImgIn" />
          <img
            :src="require('../assets/images/status_out.png')"
            v-if="showImgOutNormal"
          />
          <img
            src="../assets/images/status_small_error_out.png"
